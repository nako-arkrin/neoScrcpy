...
const zhCN = {
  ...
  "nav.shizukuAdb": "激活 Shizuku ADB 模式",
  ...
  "developer.shizuku.title": "启用 Shizuku 功能",
  "developer.shizuku.subtitle": "启用后会在设备功能页显示“激活 Shizuku ADB 模式”",
  ...
  "deviceHome.shizuku.title": "激活 Shizuku ADB 模式",
  "deviceHome.shizuku.subtitle": "检查 Shizuku 并执行 v11.2.0+ ADB 激活命令",
...
const enUS: Record<I18nKey, string> = {
  ...
  "nav.shizukuAdb": "Activate Shizuku ADB mode",
  ...
  "developer.shizuku.title": "Enable Shizuku features",
  "developer.shizuku.subtitle": "Shows \"Activate Shizuku ADB mode\" on the device tools page when enabled",
  ...
  "deviceHome.shizuku.title": "Activate Shizuku ADB mode",
  "deviceHome.shizuku.subtitle": "Check Shizuku and run the v11.2.0+ ADB activation command",
